<article id="accueil">
	...
	<img src="./image/photoMotPres.jpg" id="motPresident"><p>Madame, Monsieur,</p>

	<p><em>2013 a été une année décisive pour le Pôle.</em></p>
...
<p>
	...
	- appeler et aider à la collecte des documents et archives concernant l’histoire ouvrière, des entreprises et des associations d’économie sociale et des syndicats professionnels en partenariat avec les organismes intéressés ;

	- promouvoir un programme de sauvegarde et de valorisation de ces documents et archives (guides, numérisation partagée de corpus documentaires ou des enquêtes) en liaison avec les ministères, les chercheurs et les professionnels de la conservation (archivistes, bibliothécaires, documentalistes…);

	- conduire des projets fédérateurs (colloques, rencontres, séminaires) à l’échelle régionale, nationale et internationale ;

	- contribuer et participer à la diffusion documentaire et pédagogique des ressources exixtantes et celles découvertes…
	</ol></p>
</article>