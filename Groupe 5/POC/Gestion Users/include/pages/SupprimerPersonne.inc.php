...
if (isset($_SESSION['personne_connecte'])) {
	if ($_SESSION['personne_connecte']->getUserDroit()=='admin') {
		...
		echo "<strong> Vous devez &ecirctre connect&eacute; en tant qu'administrateur pour pouvoir supprimer des personnes</strong> <br/>";
	}
} else {
	echo "<strong> Vous devez &ecirctre connect&eacute; pour pouvoir supprimer des personnes</strong> <br/>";
}
?>