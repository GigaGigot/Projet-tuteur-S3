...
class User {
	...
	public function affecte($donnees)
	{
		foreach ($donnees as $attribut => $valeurs)
		{
			switch ($attribut)
			{
				case 'user_id' : $this->setUserId($valeurs); break;
				case 'user_login' : $this->setUserLogin($valeurs); break;
				case 'user_mdp' : $this->setUserMdp($valeurs); break;
				case 'user_nom' : $this->setUserNom($valeurs); break;
				case 'user_prenom' : $this->setUserPrenom($valeurs); break;
				case 'user_tel' : $this->setUserTel($valeurs); break;
				case 'user_email' : $this->setUserEmail($valeurs); break;
				case 'user_adherent' : $this->setUserAdherent($valeurs); break;
				case 'user_typeCompte' : $this->setUserTypeCompte($valeurs); break;
				case 'user_roles' : $this->setUserRoles($valeurs); break;
				case 'user_derniereConnexion' : $this->setUserDerniereConnexion($valeurs); break;
			}
		}
	}
